...
var basePath = system.args[0+1] || '/tmp/';

var port  = system.args[1+1] || 3001;

var defaultViewportSize = system.args[2+1] || '';

console.log('Phantomjs internal basePath: ', basePath);
console.log('Phantomjs internal PORT: ', port);
console.log('Phantomjs internal defaultViewportSize: ', defaultViewportSize);
